...
var oToken;
sap.ui.core.mvc.Controller.extend("Expense.view.S4", {
  companydescription:"",
  plantdescription:"",
  taxdescription:"",
  vendvalue1:"",
...
onSelectone:function(evt){
  this.mprest="";
  this.oModel = this.getOwnerComponent().getModel();
this.getView().byId("itab093").destroyContent();
  this.getView().byId("itab222").destroyContent();
  this.getView().byId("itab104").destroyContent();
...
{
  if(oEvent.mParameters.name=="rent"){
    this.mprest="";
    var fragment1= new sap.ui.xmlfragment("Expense.view.abc",this);
    this.getView().byId("itab093").addContent(fragment1);
     var oFileUpload = sap.ui.getCore().byId('fileupload2');
          oFileUpload.setUseMultipart(false);
          var mockData = {
           dataitems : [
  ...
  sap.ui.getCore().setModel(this.oModel);
     ...
     var data = {};
     var oController=this;
     this.oModel.read("/PROPOSALDETAILSSet(IvContype=%27093%27)",null,false,false,function(oData,response){
     ...
     this.oModel.read("/GETVENDORJCSet(Contype='093',OtherInd='',ImprestInd='I')",null,false,false,function(oData,response){
            ...
            // var pryear = x.d.Mjahr;
             sap.m.MessageBox.show(msg,{
                   ...
                   onClose : function(){
                     ...
                     sap.ui.getCore().byId("itr2").setState(false);
                     that.ccode="";
                     that.getView().byId("itab093").destroyContent();
                  that.getView().byId("itab222").destroyContent();
                  that.getView().byId("itab104").destroyContent();
...
csrfToken:function(){
  ...
  onUploadFile : function(oEventData) {
    ...
    incidentValidation:function(fileupload){
