...
var oToken;
sap.ui.core.mvc.Controller.extend("Expense.view.S3", {
  companydescription:"",
  plantdescription:"",
  taxdescription:"",
  vendvalue1:"",
...
onSelectone:function(evt){
  this.mprest="";
  this.oModel = this.getOwnerComponent().getModel();
  this.getView().byId("itab215").destroyContent();
  this.getView().byId("itab053").destroyContent();
  this.getView().byId("itab041").destroyContent();
  this.getView().byId("itab110").destroyContent();
  this.getView().byId("itab168").destroyContent();
  this.getView().byId("itab075").destroyContent();
  this.getView().byId("itab025").destroyContent();
  this.getView().byId("itab086").destroyContent();
  ...
  if(this.fragment1===undefined){
    ...
    var adf=this.getView().byId("view2").getSelectedKey();
    if(adf==="086"){
      sap.ui.getCore().byId("desc").setVisible(true);
    }
...
{
  if(oEvent.mParameters.name=="sundry"){
    this.mprest="";
    var fragment1= new sap.ui.xmlfragment("Expense.view.abc",this);
    this.getView().byId("itab215").addContent(fragment1);
    var oFileUpload = sap.ui.getCore().byId('fileupload2');
        oFileUpload.setUseMultipart(false);
        var mockData = {
         dataitems : [
  ...
  sap.ui.getCore().setModel(this.oModel);
     ...
     var data = {};
     var oController=this;
     this.oModel.read("/PROPOSALDETAILSSet(IvContype=%27215%27)",null,false,false,function(oData,response){
     ...
     this.oModel.read("/GETVENDORJCSet(Contype='215',OtherInd='',ImprestInd='I')",null,false,false,function(oData,response){
            ...
            // var x = $.parseJSON(request.body);
             ...
             sap.m.MessageBox.show(msg,{
                   ...
                   onClose : function(){
                     ...
                     sap.ui.getCore().byId("itr2").setState(false);
                     that.ccode="";
                     that.getView().byId("itab215").destroyContent();
                  that.getView().byId("itab053").destroyContent();
                  that.getView().byId("itab041").destroyContent();
                  that.getView().byId("itab110").destroyContent();
                  that.getView().byId("itab168").destroyContent();
                  that.getView().byId("itab075").destroyContent();
                  that.getView().byId("itab025").destroyContent();
                  that.getView().byId("itab086").destroyContent();
