...
jQuery.sap.require("Expense.util.formatter");
var oToken;
sap.ui.core.mvc.Controller.extend("Expense.view.S2", {
  companydescription:"",
  plantdescription:"",
  taxdescription:"",
  vendvalue1:"",
...
onSelectone:function(evt){
  this.mprest="";
  this.oModel = this.getOwnerComponent().getModel();
this.getView().byId("itab211").destroyContent();
  this.getView().byId("itab223").destroyContent();
  this.getView().byId("itab200").destroyContent();
  this.getView().byId("itab4").destroyContent();
if(this.fragment1===undefined){
  ...
  /*sap.ui.getCore().byId("robj").setVisible(false);
  sap.ui.getCore().byId("robject").setVisible(false);*/
...
{
if(oEvent.mParameters.name=="telephone"){
  this.mprest="";
  var fragment1= new sap.ui.xmlfragment("Expense.view.abc",this);
  this.getView().byId("itab211").addContent(fragment1);
  /*sap.ui.getCore().byId("robj").setVisible(false);
  sap.ui.getCore().byId("robject").setVisible(false);*/
  var oFileUpload = sap.ui.getCore().byId('fileupload2');
    oFileUpload.setUseMultipart(false);
 ...
 /* sap.ui.getCore().byId("robj").setVisible(true);
  ...
  sap.ui.getCore().setModel(this.oModel);
     ...
     var data = {};
     var oController=this;
     this.oModel.read("/PROPOSALDETAILSSet(IvContype=%27211%27)",null,false,false,function(oData,response){
     ...
     this.oModel.read("/GETVENDORJCSet(Contype='211',OtherInd='',ImprestInd='I')",null,false,false,function(oData,response){
 ...
 /* var rentalObj=sap.ui.getCore().byId("robject").getValue();
  if(rentalObj==="" || rentalObj===undefined){
            ...
            // var prp = x.d.Mblnr;
             ...
             sap.m.MessageBox.show(msg,{
                   ...
                   onClose : function(){
                     ...
                     that.ccode="";
                     that.recode="";
                     that.getView().byId("itab211").destroyContent();
                  that.getView().byId("itab223").destroyContent();
                  that.getView().byId("itab200").destroyContent();
                  that.getView().byId("itab4").destroyContent();
...
csrfToken:function(){
   ...
   var a = "../../../../../Expense/proxy/sap/opu/odata/sap/ZJIO_PROPOSAL_CREATE_JC_BT_SRV/PROPOSALDETAILSSet(IvContype=%27211%27)";
    var f = {
              headers : {
